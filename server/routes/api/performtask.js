...
router.get('/log-timer/currentTimer/:task', auth, PerformTaskController.getTimerStatus);
...
router.post('/comment-task/create', auth, PerformTaskController.createCommentTask);
