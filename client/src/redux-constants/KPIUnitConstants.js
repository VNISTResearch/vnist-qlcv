export const kpiUnitConstants = {
    ...
    EDITSTATUS_KPIUNIT_REQUEST: 'EDITSTATUS_KPIUNIT_REQUEST',
    EDITSTATUS_KPIUNIT_SUCCESS: 'EDITSTATUS_KPIUNIT_SUCCESS',
    EDITSTATUS_KPIUNIT_FAILURE: 'EDITSTATUS_KPIUNIT_FAILURE',
