...
class QLVanBan extends Component {
    constructor(props) {
        super(props);
        this.state = {  }
    }
                ...
                <div className="content-wrapper">
                    ...
                    <section className="content-header">
                        ...
                        <ol className="breadcrumb">
                            ...
                            <li className="active">Quản lý văn bản</li>
                        </ol>
                    </section>
                            ...
                            <div className="box-body">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-sm-4">
                                        <a className="btn btn-primary pull-right" data-toggle="modal" href="#modal-id">Thêm mới</a>
                                        <div className="modal fade" id="modal-id">
                                            <div className="modal-dialog" style={{ width: '80%'}}>
                                                <div className="modal-content">
                                                    <div className="modal-header">
                                                        <button type="button" className="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                        {/* <h3 className="modal-title" style={{ textAlign: 'center'}}>Thêm văn bản</h3> */}
                                                    </div>
                                                    <div className="modal-body">
                                                        <div style={{ marginLeft: '10px'}}>
                                                            <form>
                                                                ...
                                                                <br/>
                                                                <p style={{ fontSize: '14px'}}><strong>Phiên bản</strong></p>
