...
import { kpiUnitActions, kpiPersonalActions } from '../../../../../redux-actions/CombineActions';
class ModalAddTargetKPIPersonal extends Component {
    ...
    render() {
        ...
        if (kpiunits.currentKPI) parentTargets = kpiunits.currentKPI.listtarget;
        return (
...
const actionCreators = {
    getParentTarget: kpiUnitActions.getCurrentKPIUnit,
    addNewTargetPersonal: kpiPersonalActions.addNewTargetPersonal
};
