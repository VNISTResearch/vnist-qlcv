...
import { kpiUnitActions } from '../../../../../redux-actions/KPIUnitActions';
...
class ModalEditTargetKPIUnit extends Component {
    ...
    render() {
        const { kpiunits, target, unit } = this.props;
        const {editing, newTarget} = this.state;
        var parentKPI;
        if (kpiunits.parent) parentKPI = kpiunits.parent;
        return (
...
const actionCreators = {
    getParentTarget: kpiUnitActions.getKPIParent,
    editTargetKPIUnit: kpiUnitActions.editTargetKPIUnit
};
