                                ...
                                <div className="col-md-12">
                                    <div className="box box-info">
                                        <div className="box-header with-border">
                                            <h3 className="box-title">Bảng trạng thái đánh giá KPI nhân viên</h3>
                                                ...
                                                <table id="example1" className="table table-bordered table-striped">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>Đã đánh giá</td>
                                                            <td>
                                                                <a href="#data-kpi-member" className="view" title="Xem chi tiết"><i className="material-icons">visibility</i></a>
