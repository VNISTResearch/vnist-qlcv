                                                    ...
                                                    <input className="upload" type="file" name="file" onChange={this.handleUpload} />
                                                        ...
                                                        <div className=" col-md-4 " style={{ marginTop: 30 }}>
                                                            ...
                                                            <div className="form-group">
                                                                ...
                                                                <input type="text" className="form-control" name="birthplace" defaultValue={employee.birthplace} onChange={this.handleChange} />
                                                            </div>
                                                            <div className="form-group">
                                                                ...
                                                                <label style={{ display: 'block', paddingBottom: 7 }}>Tình trạng hôn nhân:</label>
                                                                {
                                                                    employee.relationship === "Độc thân" ?
                                                                        <input type="radio" name="relationship" value="Độc thân" className="" defaultChecked style={{ marginLeft: 30, marginRight: 5 }} onChange={this.handleChange} /> :
                                                                ...
                                                                <label> Độc thân</label>
                                                                {
                                                                    employee.relationship === "Đã kết hôn" ?
                                                    ...
                                                    <div className="col-md-12">
                                                        <div className="col-md-4">
                                                            <div className="form-group">
                                                                ...
                                                                <input type="number" className="form-control" name="CMND" defaultValue={employee.CMND} onChange={this.handleChange} />
                                                            </div>
                                                            <div className="form-group">
                                                                <label htmlFor="national">Dân tộc:</label>
                                                                <input type="text" className="form-control" name="national" defaultValue={employee.national} onChange={this.handleChange} />
                                                            </div>
                                                        </div>
                                                        <div className="col-md-4">
                                                            <div className="form-group">
                                                                <label htmlFor="dateCMND">Ngày cấp:<span className="required">&#42;</span></label>
                                                                <input type="Date" className="form-control" name="dateCMND" defaultValue={employee.dateCMND} onChange={this.handleChange} />
                                                            </div>
                                                            <div className="form-group">
                                                                <label htmlFor="religion">Tôn giáo:</label>
                                                                <input type="text" className="form-control" name="religion" defaultValue={employee.religion} onChange={this.handleChange} />
                                                            </div>
                                                        ...
                                                        <div className="col-md-4">
                                                            <div className="form-group">
                                                                ...
                                                                <input type="text" className="form-control" name="addressCMND" defaultValue={employee.addressCMND} onChange={this.handleChange} />
                                                            </div>
                                                            <div className="form-group">
                                                                <label htmlFor="nation">Quốc tịch:</label>
                                                                <input type="text" className="form-control" name="nation" defaultValue={employee.nation} onChange={this.handleChange} />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            {employeeContact && employeeContact.map((employeeContact, index) => (
                                                <div id="editthongtinlienhe" className="tab-pane" key={index} >
                                                    <div className="box-body">
                                                        <div className="col-md-4">
