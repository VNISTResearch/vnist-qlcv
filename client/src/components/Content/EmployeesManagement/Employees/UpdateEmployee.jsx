                                        ...
                                        <div className="col-md-12">
                                            ...
                                            <div className=" col-md-4">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <input type="text" className="form-control" id="national" defaultValue="Kinh" />
                                                </div>
                                            </div>
                                            <div className=" col-md-4">
                                                <div className="form-group">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <input type="text" className="form-control" id="religion" defaultValue="Không"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-md-12">
                                            ...
                                            <div className="col-md-4">
                                                <div className="form-group">
                                                    ...
                                                    <input type="text" className="form-control" id="phoneNumber" defaultValue="0386259896"/>
                                                </div>
                                            </div>
                                            <div className="col-md-4">
                                                <div className="form-group">
                                                    <label htmlFor="email">Email cá nhân:</label>
                                                    <input type="text" className="form-control" id="email" defaultValue="cuong123456@gmail.com"/>
                                                </div>
                                            </div>
                                            <div className="col-md-4">
                                                <div className="form-group">
                                                    <label htmlFor="phoneNumberAddress">Điện thoại nhà riêng:</label>
                                                    <input type="text" className="form-control" id="phoneNumberAddress" defaultValue="0386259896"/>
                                                </div>
                                            </div>
                                                ...
                                                <fieldset className="scheduler-border">
                                                    ...
                                                    <div className="col-md-6">
                                                        <div className="form-group" >
                                                            ...
                                                            <input type="text" className="form-control" id="friendName" defaultValue="Trần Đức thuận"/>
                                                            
                                                        </div>
                                                        <div className="form-group" >
                                                            <label htmlFor="quanhe">Quan hệ:</label>
                                                            <input type="text" className="form-control" id="quanhe" defaultValue="Anh trai"/>
                                                        </div>
                                                        <div className="form-group" >
                                                            <label htmlFor="friendPhone">Điện Thoại di động:</label>
                                                            <input type="text" className="form-control" id="friendPhone" defaultValue="0385629874"/>
                                                        </div>
                                                        <div className="form-group" >
                                                            <label htmlFor="friendEmail">Email:</label>
                                                            <input type="text" className="form-control" id="friendEmail" defaultValue="thuan123456@gmail.com"/>
                                                        </div>
                                                    ...
                                                    <div className="col-md-6">
                                                        <div className="form-group" >
                                                            ...
                                                            <input type="text" className="form-control" id="friendPhoneAddress" defaultValue="0385629874"/>
                                                        </div>
                                                        <div className="form-group" >
                                                            <label htmlFor="friendAddress">Địa chỉ:</label>
                                                            <input type="text" className="form-control" id="friendAddress" defaultValue="Hải Phương - Hải Hậu - Nam Định"/>
                                                        </div>
                                                    </div>
                                                </fieldset>
                                            </div>
                                            ...
                                            <div className="col-md-6">
                                                <fieldset className="scheduler-border">
                                                    ...
                                                    <div className="form-group" >
                                                        ...
                                                        <input type="text" className="form-control" id="localAddress" defaultValue="Hải Phương - Hải Hậu - Nam Định"/>
                                                    </div>
                                                    <div className="form-group" >
                                                        <label htmlFor="localNational">Quốc gia:</label>
                                                        <input type="text" className="form-control" id="localNational" defaultValue="Việt Nam"/>
                                                    </div>
                                                    <div className="form-group" >
                                                        <label htmlFor="localCity">Tỉnh/Thành phố:</label>
                                                        <input type="text" className="form-control" id="localCity" defaultValue="Nam Định"/>
                                                    </div>
                                                    <div className="form-group" >
                                                        <label htmlFor="localDistrict">Quận/Huyện:</label>
                                                        <input type="text" className="form-control" id="localDistrict" defaultValue="Hải Hậu"/>
                                                    </div>
                                                    <div className="form-group" >
                                                        <label htmlFor="localCommune">Xã/Phường:</label>
                                                        <input type="text" className="form-control" id="localCommune" defaultValue="Hải Phương"/>
                                                    </div>
                                                </fieldset>
                                            </div>
                                            ...
                                            <div className="col-md-6">
                                                <fieldset className="scheduler-border">
                                                    ...
                                                    <div className="form-group" >
                                                        ...
                                                        <input type="text" className="form-control" id="nowAddress" defaultValue="Hải Phương - Hải Hậu - Nam Định"/>
                                                    </div>
                                                    <div className="form-group" >
                                                        <label htmlFor="nowNational">Quốc gia:</label>
                                                        <input type="text" className="form-control" id="nowNational" defaultValue="Việt Nam"/>
                                                    </div>
                                                    <div className="form-group" >
                                                        <label htmlFor="nowCity">Tỉnh/Thành phố:</label>
                                                        <input type="text" className="form-control" id="nowCity" defaultValue="Nam Định"/>
                                                    </div>
                                                    <div className="form-group" >
                                                        <label htmlFor="nowDistrict">Quận/Huyện:</label>
                                                        <input type="text" className="form-control" id="nowDistrict" defaultValue="Hải Hậu"/>
                                                    </div>
                                                    <div className="form-group" >
                                                        <label htmlFor="nowCommune">Xã/Phường:</label>
                                                        <input type="text" className="form-control" id="nowCommune" defaultValue="Hải Phương"/>
                                                    </div>
                                                </fieldset>
                                            </div>
                                        </div>
