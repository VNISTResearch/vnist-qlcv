                                        ...
                                        <div className="col-md-3" style={{ paddingRight: 0 }}>
                                            <div className="form-group pull-right" >
                                                ...
                                                <ul className="dropdown-menu pull-right">
                                                    <li><a href="#abc" title="Thêm nhiều bảng lương" data-toggle="modal" data-target="#modal-importFileSalary">Import file Excel</a></li>
                                                    <li><a href="#abc" title="Thêm một bảng lương" data-toggle="modal" data-target="#modal-addSalary">Thêm bằng tay</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
