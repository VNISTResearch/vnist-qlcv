...
class ModalPerformTask extends Component {
    ...
    render() {
        ...
        const { tasks, performtasks, user, kpipersonals } = this.props;
                        ...
                        <div className="modal-body modal-body-perform-task" >
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-sm-12">
                                        {extendApproveRessult && <React.Fragment>
                                            ...
                                            {task && task.responsible.map(item => <div className="col-sm-12" key={item._id}>
                                            ...
                                            {task && task.accounatable.map(item => <div className="col-sm-12" key={item._id}>
                                                <div className="control-label col-sm-3" style={{ width: "12%" }}>
                                                    <label style={{ fontWeight: "500" }}>{item.name}:</label>
                                                </div>
                                                <div className="col-sm-4">
                                            ...
                                            {task && task.consulted.map(item => <div className="col-sm-12" key={item._id}>
                                                <div className="control-label col-sm-3" style={{ width: "12%" }}>
                                                    <label style={{ fontWeight: "500" }}>{item.name}:</label>
                                                </div>
                                                <div className="col-sm-4">
                            ...
                            <div className="nav-tabs-custom">
                                ...
                                <div className="tab-content">
                                                                        ...
                                                                        <div className="col-sm-12 margin-bottom-none">
                                                                            ...
                                                                            <div className="col-sm-11" >
                                                                                ...
                                                                                <div className="row action-post" style={{ width: "107%" }}>
                                                                                    ...
                                                                                    <button style={{ width: "20%", marginRight: "2%" }} className="col-xs-2 btn btn-success btn-sm" onClick={(e) => this.submitComment(e, item._id, item._id)}>Gửi bình luận</button>
                                    ...
                                    <div className={selected === "commentTask" ? "active tab-pane" : "tab-pane"} id="commentTask"></div>
...
function mapState(state) {
    const { tasks, performtasks, user, kpipersonals } = state;
    return { tasks, performtasks, user, kpipersonals };
}
...
const actionCreators = {
    ...
    getAllKPIPersonalByMember: kpiPersonalActions.getAllKPIPersonalOfResponsible
};
