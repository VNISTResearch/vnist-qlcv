...
import { edit } from '../../../redux-actions/SystemAdmin/Companies.action';
...
class CompanyEdit extends Component {
    ...
    render() { 
        const { translate, companyID,companyName, companyDescription } = this.props;
        return ( 
            <React.Fragment>
                <a className="btn btn-primary" data-toggle="modal" href={ `#modal-company-${companyID}` } ><i className="fa fa-info"></i></a>
...
export default connect( mapStateToProps, mapDispatchToProps )( withTranslate(CompanyEdit) );