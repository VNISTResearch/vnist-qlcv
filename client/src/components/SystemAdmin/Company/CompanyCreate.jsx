...
import { create } from '../../../redux-actions/SystemAdmin/Companies.action'
...
class CompanyCreate extends Component {
    ...
    save = (e) => {
        ...
        const company = { name, description, email };
    ...
    render() { 
        ...
        return ( 
            <React.Fragment>
                <div>
                    <a className="btn btn-primary" data-toggle="modal" href="#modal-create-company">
                        <i className="fa fa-plus"></i>
                        { translate('manageCompany.create') }
                    </a>
                                ...
                                <div className="modal-body">
                                    <form style={{ marginBottom: '20px' }} >
                                        ...
                                        <div className="form-group">
                                            ...
                                            <textarea  style={{ height: '250px' }}  type="text" className="form-control" name="description" onChange={ this.inputChange }/>
                                        </div>
                                        <div className="form-group">
...
export default connect( mapStateToProps, mapDispatchToProps )( withTranslate(CompanyCreate) );